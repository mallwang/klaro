...
- Name: multilanguage.spec.ts >> Multilanguage Support >> US2 – selected language is persisted after page reload
- Location: tests/e2e/multilanguage.spec.ts:85:3
...
Locator: getByText(/Vertragsübersicht|Monatliche|Verträge verwalten/i)
Expected: visible
Error: strict mode violation: getByText(/Vertragsübersicht|Monatliche|Verträge verwalten/i) resolved to 3 elements:
...
Call log:
  ...
  - waiting for getByText(/Vertragsübersicht|Monatliche|Verträge verwalten/i)
