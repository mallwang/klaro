...
- Name: multilanguage.spec.ts >> Multilanguage Support >> US1 – switching from English to German updates all visible text without page reload
- Location: tests/e2e/multilanguage.spec.ts:20:3
...
Locator: getByText(/Vertragsübersicht|Verträge verwalten|Monatliche/i)
Expected: visible
Error: strict mode violation: getByText(/Vertragsübersicht|Verträge verwalten|Monatliche/i) resolved to 3 elements:
    1) <p class="text-sm text-[--color-muted-foreground]">Ihre Vertragsübersicht</p> aka getByText('Ihre Vertragsübersicht')
    2) <a href="/contracts" data-discover="true" class="rounded border px-4 py-2 text-sm font-medium hover:bg-background">Verträge verwalten</a> aka getByRole('link', { name: 'Verträge verwalten' })
    3) <span role="tooltip" class="pointer-events-none absolute left-0 top-full z-50 mt-1 w-64 rounded bg-foreground px-2.5 py-2 text-xs leading-relaxed text-background opacity-0 transition-opacity group-hover:opacity-100 group-focus-within:opacity-100">Durchschnittliche monatliche Kosten aller aktiven…</span> aka getByRole('tooltip', { name: 'Durchschnittliche monatliche' })

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByText(/Vertragsübersicht|Verträge verwalten|Monatliche/i)
            ...
            - region "Nach Kategorie" [ref=e30]:
                - generic [ref=e31]:
                    ...
                    - table [ref=e35]:
                        ...
                        - rowgroup [ref=e41]:
                            - row "Subscriptions 14 89,50 €" [ref=e42]:
